...
export default function ToolContentPage({ eyebrow, title, description, sections, action, active = 'calculator' }: { eyebrow: string; title: string; description: string; sections: ContentSection[]; action: { href: string; label: string }; active?: 'calculator' | 'tax-rate' }) {
