...
const tools = [
  ...
  { href: '/calculator#tax-rate-table', icon: Percent, title: '税率表', description: '快速查看工资薪金累计预扣预缴税率和速算扣除数。', label: '查看税率' },
...
export default function HomePage() {
  return <div className="app-shell">
    <header className="topbar">
      ...
      <nav className="main-nav" aria-label="主导航"><a className="active" href="#top">首页</a><a href="/calculator">工资薪金</a><a href="/calculator#bonus">年终奖</a><a href="/calculator#reverse">税后反推</a><a href="/calculator#deduction">专项扣除</a><a href="/calculator#tax-rate-table">税率表</a><a href="/calculator#faq">FAQ</a></nav>
      <ThemeToggle />
    </header>
    ...
    <section className="home-hero">
      <div className="home-hero-copy">
        ...
        <div className="home-actions"><Link className="home-primary-action" href="/calculator">开始算工资 <ArrowRight size={17} /></Link><Link className="home-secondary-action" href="/calculator#tax-rate-table">先看税率表</Link></div>
      </div>
      <div className="home-hero-note"><span className="status-dot" /><span>规则核对日期</span><strong>2026-07-27</strong></div>
    </section>
